        ...
        <div className="mt-24 flex flex-col items-center justify-between gap-6 border-t border-white/5 pt-12 md:flex-row">
          ...
          <div className="flex gap-8">
            <button 
              ...
              className="text-[10px] tracking-widest uppercase text-white/30 hover:text-white outline-none focus-visible:text-white focus-visible:ring-1 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-matte-ink rounded-sm"
            >
              Privacy Policy
            </button>
          </div>
